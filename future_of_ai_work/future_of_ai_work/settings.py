import os
"""
Django settings for future_of_ai_work project.
...
SECRET_KEY = 'django-insecure-3o8=w95_k47fx$5la7^+lk!5&8-&h0@i_t5y0x#i=@6$(l(=pa'
...
ROOT_URLCONF = 'future_of_ai_work.urls'
TEMPLATES = [
    {
...
WSGI_APPLICATION = 'future_of_ai_work.wsgi.application'
